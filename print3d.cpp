...
bool Print3D::snapshot(int width, int height, GLbyte *buffer, const char *path)
{
    ...
    if(!strcasecmp(pos,"bmp"))
        return snapshot_bmp(width,height,buffer,path);
    else
    {
...
bool Print3D::snapshot_bmp(int width, int height,GLbyte *buffer, const char *path)
{
...
//bool Print3D::snapshot_jpg(int width, int height, const char *path, int quality)
//{
...
//bool Print3D::snapshot_tiff(int width, int height, const char *path)
//{
